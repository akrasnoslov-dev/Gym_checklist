...
- PR #3 CI optimization: Linux run `35869049678` passed on `79621c199b9ce41fcc81f11a9834ee231ab604f7`. iOS-impacting PRs now use automatic `smoke`; process-only changes start no macOS run; manual `full` and exact-SHA `candidate` remain authoritative.
