...
- PR #3 CI optimization: initial Linux run `35869049678` passed on `79621c199b9ce41fcc81f11a9834ee231ab604f7`. The review-hardening follow-up remains pending Linux CI; it preserves automatic `smoke`, no macOS for process-only changes, and manual `full`/exact-SHA `candidate`.
